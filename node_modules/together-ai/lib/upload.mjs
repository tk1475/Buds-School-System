...
export async function check_file(fileName) {
...
export async function check_parquet(fileName) {
    try {
...
export async function check_jsonl(fileName) {
...
export async function upload(fileName, check = true) {

...
export declare namespace ChatCompletionStructuredMessageImageURL {
    interface ImageURL {
        /**
...
export declare namespace CompletionCreateParams {
    interface Message {
         ...
         * format.
         */
        content: string | Array<ChatCompletionsAPI.ChatCompletionStructuredMessageText | ChatCompletionsAPI.ChatCompletionStructuredMessageImageURL | Message.Video>;
        /**
